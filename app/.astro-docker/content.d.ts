...
"coming-soon": Record<string, {
  id: string;
  render(): Render[".md"];
  slug: string;
  body: string;
  collection: "coming-soon";
  data: InferEntrySchema<"coming-soon">;
  rendered?: RenderedContent;
  filePath?: string;
}>;
...
"school-info": Record<string, {
  id: string;
  render(): Render[".md"];
  slug: string;
  body: string;
  collection: "school-info";
  data: InferEntrySchema<"school-info">;
  rendered?: RenderedContent;
  filePath?: string;
}>;
